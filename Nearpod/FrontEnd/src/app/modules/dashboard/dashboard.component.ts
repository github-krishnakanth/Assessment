...
const ELEMENT_DATA: CampaignRecords[] = [
  { name: '123 Campaign', duration: '1 APR - 2 JUN 2020', status: 'Processing', report:'In 23 Days' },
  { name: 'Star Campaign', duration: '1 APR - 2 JUN 2020', status: 'Waiting',  report: 'In 40 Days' },
];
*/
